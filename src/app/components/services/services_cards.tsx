...
const Cards = ()=>{
    ...
    return (
        <div className="columns-1 md:columns-2 rounded-[25px] md:rounded-[0] bg-gradient-to-b from-services_blue  to-services_light_blue md:bg-none shadow-services_shadow">
